### 진짜 오래 고민했던 문제ㅜㅜㅜ 경계값 제대로 설정하는데서 헷갈렸고 관건은 시간을 어떻게 줄이냐였음
### 각 초별로 vierwer 수 저장할 때 start ~ end 까지 다 돌면서 +1 하는 건 시간초과 뜸
### log loop 돌 때는 마킹만 하고(start는 +1, end는 -1) 마지막에 한번 훑으면서 i-1 값이랑 더해주는 방법으로 시간 줄일 수 있었다..
### @ a ~ b 특정구간의 누적 합을 구할 때, "b까지의 누적합 - a까지의 누적합"으로 접근하는 방법 잘 기억해두자!

#

# [level 3] 광고 삽입 - 72414 

[문제 링크](https://programmers.co.kr/learn/courses/30/lessons/72414#fnref1) 

### 성능 요약

메모리: 12.3 MB, 시간: 29.08 ms
